<head>
    ...
    <!-- ace styles -->
    <link rel="stylesheet" href="{{ asset('admin_panel/assets/css/ace.min.css') }}" class="ace-main-stylesheet" id="main-ace-style" />

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="{{ asset('admin_panel/assets/css/ace-part2.min.css')}}" class="ace-main-stylesheet" />
    <![endif]-->
    <link rel="stylesheet" href="{{ asset('admin_panel/assets/css/ace-skins.min.css') }}" />
    ...
    <script src="{{ asset('admin_panel/assets/js/ace-extra.min.js') }}"></script>
